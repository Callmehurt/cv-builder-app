...
<html data-navigation-type="default" data-navbar-horizontal-shape="default" lang="en-US" dir="ltr">
  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <!-- Side Navigation   -->
      @include('agency.navigation.sidebar')
        ...
        <footer class="footer position-absolute">
          <div class="row g-0 justify-content-between align-items-center h-100">
            <div class="col-12 col-sm-auto text-center">
              <p class="mb-0 mt-2 mt-sm-0 text-body">Thank you for your love<span class="d-none d-sm-inline-block"></span><span class="d-none d-sm-inline-block mx-1">|</span><br class="d-sm-none" />2024 &copy;<a class="mx-1" href="https://therichpost.com">therichpost</a></p>
            </div>
            <div class="col-12 col-sm-auto text-center">
